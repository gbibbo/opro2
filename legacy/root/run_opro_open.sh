#!/bin/bash
#SBATCH --job-name=opro_open
#SBATCH --partition=debug
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --time=03:00:00
#SBATCH --output=/mnt/fast/nobackup/users/gb0048/opro/logs/opro_open_%j.out
#SBATCH --error=/mnt/fast/nobackup/users/gb0048/opro/logs/opro_open_%j.err

# OPRO on BASE model with Open-ended format (free generation)
...
echo "[RUN] OPRO Open-ended format (free generation with normalization)"
...
echo "[DONE] End: $(date)"
echo "Results: results/opro_open/"
